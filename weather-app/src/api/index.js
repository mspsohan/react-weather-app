...
const API_APPID = import.meta.env.VITE_REACT_APP_API_KEY_APPID;
const API_UNPSLASH = import.meta.env.VITE_REACT_APP_API_KEY_UNSPLASH;
...
const DEF_N_D_H = `https://openweathermap.org/data/2.5/onecall?exclude=minutely&appid=${API_APPID}&lat=41.390205&lon=2.154007`;
